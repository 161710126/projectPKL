		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 centPic">
					<img class="img-responsive"  src="{{asset('assets/user/images/bizPic.png')}}"/>
				</div>
			</div>
		</div>   
    </div>
		...
		<div style="position: relative;">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="{{asset('assets/user/images/picAbout/aboutP1.png')}}">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="{{asset('assets/user/images/picAbout/aboutP2.png')}}">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="{{asset('assets/user/images/picAbout/aboutP3.png')}}">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="{{asset('assets/user/images/picAbout/aboutP4.png')}}">
    ...
    <div id="news">
		...
		<div class="container">
				<div class="row news">
					...
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news1.jpg')}}"/>
					...
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news2.jpg')}}"/>
			...
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news3.jpg')}}"/>
					<h3><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news4.jpg')}}"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
			...
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news5.jpg')}}"/>
					<h3 ><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="{{asset('assets/user/images/picNews/news6.jpg')}}"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-xs-12 cont">
					<ul>
						<li><i class="fa fa-home"></i>DESA KEBAN II Kec.Sanga Desa Kab.Musi Banyuasin</li>
						<li><i class="fa fa-phone"></i>+081377714255, +08127446510</li>

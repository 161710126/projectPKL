...
class KategoriArtikelController extends Controller
 {
    public function index()
    {
        ...
        return view('kategori_artikel.index',compact('kartikel')); 
    }
    ...
    public function show($id)
    {
        ...
        return view('kategori_artikel.show',compact('kartikel'));    }
    ...
    {
        $kartikel = kategori_artikel::findOrFail($id);
        return view('kategori_artikel.edit',compact('kartikel'));     }
